...
import soccer from "@/public/svg/scoccer.svg";

export default function AboutPage() {
  return (
    <div className="align-left max-w-full mx-12 py-12 px-4 text-gray-200 relative">
      {/* Background Soccer SVG */}
      <div className="absolute top-30 right-10 opacity-40 scale-120 pointer-events-none z-0">
        <Image
          src={soccer}
